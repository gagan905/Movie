...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(movieService, router) {
...
var DetailsPageComponent = /** @class */ (function () {
    function DetailsPageComponent(movieService, route, router) {
        this.movieService = movieService;
        this.route = route;
        this.router = router;
        this.pageContent = {
    ...
    DetailsPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (params) {
            return _this.movieService.getSingleMovie(params['movieid']);
        }))
    ...
    DetailsPageComponent.prototype.deleteMovie = function (movieid) {
...
var HomeListComponent = /** @class */ (function () {
    ...
    HomeListComponent.ctorParameters = function () { return [
        { type: _movie_service__WEBPACK_IMPORTED_MODULE_2__["MovieService"] }
    ]; };
...
var MovieService = /** @class */ (function () {
    ...
    MovieService.prototype.getSingleMovie = function (movieid) {
        return this.http.get(this.movieUrl + '/' + movieid)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    MovieService.prototype.createMovie = function (newMovie) {
        return this.http.post(this.movieUrl, newMovie)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    MovieService.prototype.updateMovie = function (newMovie) {
...
var UpdateComponent = /** @class */ (function () {
    function UpdateComponent(movieService, route, router) {
        this.movieService = movieService;
        this.route = route;
        this.router = router;
        this.pageContent = {
    ...
    UpdateComponent.prototype.updateMovie = function (newMovie) {
